...
class Footer_MenusController extends Controller
{
    ...
    {
        $modules = Module::all();
        $menuItems = FooterMenu::where("parent", 0)->orderBy('hierarchy', 'asc')->get();
        
        return View('la.footer_menus.index', [
            'menus' => $menuItems,
            'modules' => $modules
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if($type == "module") {
            ...
            return redirect(config('laraadmin.adminRoute').'/footer_menus');
        }
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route(config('laraadmin.adminRoute').'.footer_menus.index');
    }
    ...
    function apply_hierarchy($menuItem, $num, $parent_id)
    {
        ...
        $menu = FooterMenu::find($menuItem['id']);
