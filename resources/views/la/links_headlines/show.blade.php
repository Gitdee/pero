...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $links_headline->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Links_Headlines", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/links_headlines/'.$links_headline->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Links_Headlines", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.links_headlines.destroy', $links_headline->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/links_headlines') }}" data-toggle="tooltip" data-placement="right" title="Back to Links Headlines"><i class="fa fa-chevron-left"></i></a></li>
