...
@section("contentheader_title", "Footer Menus")
@section("contentheader_description", "Editor")
@section("section", "Footer Menus")
@section("sub_section", "Editor")
@section("htmlheader_title", "Footer Menu Editor")
				...
				<div class="nav-tabs-custom">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab-custom-link">
							...
							{!! Form::open(['action' => '\App\Http\Controllers\LA\Footer_MenusController@store', 'id' => 'menu-custom-form']) !!}
				...
				<div class="dd" id="menu-nestable">
					<ol class="dd-list">
						@foreach ($menus as $menu)
							<?php echo LAHelper::print_menu_editor($menu, "App\Models\FooterMenu", "footer_menus"); ?>
						@endforeach
					</ol>
				</div>
			</div>
...
<div class="modal fade" id="EditModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			{!! Form::open(['action' => ['\App\Http\Controllers\LA\Footer_MenusController@update', 1], 'id' => 'menu-edit-form']) !!}
...
$(function () {
	...
	$('#menu-nestable').on('change', function() {
		...
		$.ajax({
			url: "{{ url(config('laraadmin.adminRoute') . '/footer_menus/update_hierarchy') }}",
			method: 'POST',
			data: {
				jsonData: jsonData,
				"_token": '{{ csrf_token() }}'
	...
	$("#tab-modules .addModuleMenu").on("click", function() {
		...
		$.ajax({
			url: "{{ url(config('laraadmin.adminRoute') . '/footer_menus') }}",
			method: 'POST',
			data: {
				type: 'module',
				module_id: module_id,
