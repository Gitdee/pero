...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $news_headline->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("News_Headlines", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/news_headlines/'.$news_headline->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("News_Headlines", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.news_headlines.destroy', $news_headline->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/news_headlines') }}" data-toggle="tooltip" data-placement="right" title="Back to News Headlines"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'more_button_ua')
						@la_display($module, 'more_button_ru')
						@la_display($module, 'more_button_en')
						@la_display($module, 'position')
						@la_display($module, 'region_headline')
						@la_display($module, 'status')
						@la_display($module, 'meta_title_ua')
						@la_display($module, 'meta_title_ru')
						@la_display($module, 'meta_title_en')
						@la_display($module, 'meta_keywords_ua')
						@la_display($module, 'meta_keywords_ru')
						@la_display($module, 'meta_keywords_en')
						@la_display($module, 'meta_description_ua')
						@la_display($module, 'meta_description_ru')
						@la_display($module, 'meta_description_en')
					</div>
				</div>
			</div>
		</div>
