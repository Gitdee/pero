...
class CreateLinksHeadlinesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Links_headlines", 'links_headlines', 'title_ua', 'fa-external-link', [
            ...
            ["placing", "Placing", "Dropdown", false, "", 0, 0, false, ["Left Side","Right Side"]],
    ...
    {
        if (Schema::hasTable('links_headlines')) {
            Schema::drop('links_headlines');
        }
    }
}
