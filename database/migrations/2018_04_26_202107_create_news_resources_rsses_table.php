...
class CreateNewsResourcesRssesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("News_resources_rsses", 'news_resources_rsses', 'title', 'fa-rss', [
    ...
    {
        if (Schema::hasTable('news_resources_rsses')) {
            Schema::drop('news_resources_rsses');
        }
    }
}
